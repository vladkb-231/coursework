...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMatchENDCLASS_t qt_meta_stringdata_CLASSMatchENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(17, 0),  // ""
        QT_MOC_LITERAL(18, 10),  // "MatchEvent"
        QT_MOC_LITERAL(29, 5),  // "event"
        QT_MOC_LITERAL(35, 12),  // "scoreChanged"
        QT_MOC_LITERAL(48, 10),  // "team1Score"
        QT_MOC_LITERAL(59, 10)   // "team2Score"
    },
    "Match",
    "eventAdded",
    "",
...
void Match::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->eventAdded((*reinterpret_cast< std::add_pointer_t<MatchEvent>>(_a[1]))); break;
        ...
        {
            using _t = void (Match::*)(const MatchEvent & );
        ...
        {
            using _t = void (Match::*)(int , int );
            if (_t _q_method = &Match::scoreChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Match::eventAdded(const MatchEvent & _t1)
{
...
// SIGNAL 1
void Match::scoreChanged(int _t1, int _t2)
{
